submit_laudo = {
    ob_tardio : function() {
      ...
      quill.setContents([
          ...
          {insert : bcf_conc + "\nBiometria atual compatível com " + weeks + " semanas e " + days + " dia" + days_plural + " (variação de até +/- %) (Hadlock et al).\n\n"}
    ...
    ob_inicial : function() {
      ...
      var sg_mean = Math.round((sg1 + sg2 + sg3)/3,1);
...
function computeEFWPercentile(MAWeeks, MADays, Measured) {
  ...
  if ((MAWeeks == null) || (MAWeeks == "") || (isNaN(MAWeeks))) {
    alert('Please enter the weeks for gestational age');
    return false;
  }

  if ((MADays > 6) || (MADays < 0) || (isNaN(MADays))) {
